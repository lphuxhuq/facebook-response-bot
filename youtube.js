  ...
  switch (handleReply.type) {
    case 'link': {
      if(body == '1') {
        return api.sendMessage({ 
          body: `ðŸŽµ Youtube: ${handleReply.data.title}\nâ±ï¸ Thá»i gian: ${handleReply.data.duration}\nðŸ’¿====DISME PROJECT====ðŸ’¿`,
    ...
    case 'reply': {
      ...
      try {
        ...
        return api.sendMessage('ÄÃ£ cÃ³ lá»—i xáº£y ra, khÃ´ng thá»ƒ thá»±c hiá»‡n lá»‡nh lÃºc nÃ y!', threadID, messageID);
      }
    }
    default: return
  }
...
module.exports.run = async function ({ api, event, args, utils }) {
  ...
  if (args.join(" ").indexOf("https://") == 0) {
    ...
    return api.sendMessage('Vui lÃ²ng reply cÃ¡c lá»±a chá»n dÆ°á»›i Ä‘Ã¢y: 1. Táº£i video\n2. Táº£i audio', threadID, 
      (error, info) => global.client.handleReply.push({
        type: 'reply',
        name: this.config.name,
        messageID: info.messageID,
