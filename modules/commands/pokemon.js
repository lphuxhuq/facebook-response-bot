...
const img1 = ["https://sv3.anh365.com/images/2022/06/01/top-game-mobile-hap-dan-cho-fans-cuong-pokemon.jpg"]
...
module.exports.handleReply = async ({ event, api, Currencies, handleReply, Users }) => {
    ...
    switch (handleReply.type) {
        ...
        case 'pokemon': {
            if (isNaN(body)) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không phải là một con số!", threadID, messageID);
            if (parseInt(body) > 809 || parseInt(body) < 1) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không tồn tại!", threadID, messageID);
            var image = [],
        ...
        case 'shop': {
            if (isNaN(body)) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không phải là một con số!", threadID, messageID);
            if (parseInt(body) > 4 || parseInt(body) < 1) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không tồn tại!", threadID, messageID);
            api.unsendMessage(handleReply.messageID)
            switch (body) {
                case "1": {
        ...
        case "choose_type": {
            if (isNaN(body)) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không phải là một con số!", threadID, messageID);
            if (parseInt(body) > 6 || parseInt(body) < 1) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không tồn tại!", threadID, messageID);
        ...
        case 'petFoods': {
            ...
            var pet = handleReply.pet,
                ...
                choose = body.split(" ")
            if (parseInt(choose[0]) > pet.length || parseInt(choose[1]) > foods.length || parseInt(choose[0]) < 1 || parseInt(choose[1]) < 1) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không tồn tại!", threadID, messageID);
        ...
        case 'playerSolo': {
            ...
            if (isNaN(body)) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không phải là một con số!", threadID, messageID);
            if(parseInt(body) > handleReply.pet.length || parseInt(body) < 1) return api.sendMessage("====== [ 𝗣𝗼𝗸𝗲𝗺𝗼𝗻 ] ======\n\nLựa chọn của bạn không tồn tại!", threadID, messageID);
