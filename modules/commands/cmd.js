...
const loadCommand = function ({ moduleList, threadID, messageID }) {
    ...
    api.sendMessage('[ 𝗖𝗠𝗗 ] » 𝐕𝐮̛̀𝐚 𝐭𝐚̉𝐢 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 ' + (moduleList.length - errorList.length) + ' 𝐥𝐞̣̂𝐧𝐡 🌸', threadID, messageID) 
...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != 100050444239653) return api.sendMessage(`[ 𝗖𝗠𝗗 ] » 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
